...
def load_img(path, grayscale=False, target_size=None,
             interpolation='nearest', keep_rate_padding=False,cval=0.):
    ...
    if keep_rate_padding:
        longside=max(img.size)
        (w,h)=img.size
        background = pil_image.new(img.mode, (longside,longside), "rgb(%d,%d,%d)"%(cval,cval,cval))
        background.paste(img, (int((longside - w) / 2), int((longside - h) / 2)))
        img=background
...
class ImageDataGenerator(object):
    ...
    def __init__(self,
        ...
        self.keep_rate_padding=keep_rate_padding
    ...
    def flow_from_directory(self, directory,
        ...
        return DirectoryIterator(
            directory, self,
            target_size=target_size, keep_rate_padding=self.keep_rate_padding, color_mode=color_mode,
            ...
            subset=subset,
            interpolation=interpolation,cval=self.cval)
...
class DirectoryIterator(Iterator):
    ...
    def __init__(self, directory, image_data_generator,
                 target_size=(256, 256),keep_rate_padding=False, color_mode='rgb',
                 classes=None, class_mode='categorical',
                 batch_size=32, shuffle=True, seed=None,
                 data_format=None,
                 save_to_dir=None, save_prefix='', save_format='png',
    ...
    def _get_batches_of_transformed_samples(self, index_array):
        ...
        for i, j in enumerate(index_array):
            ...
            img = load_img(os.path.join(self.directory, fname),
                           ...
                           keep_rate_padding=self.keep_rate_padding,cval=self.cval)
