...
def Atrous_Resnet50(include_top=True, weights='imagenet',
             input_tensor=None, input_shape=None,
             pooling=None,
             classes=1000, batch_momentum=0.99):
    ...
    f_shape = int_shape(x)[1:3]
    x = AveragePooling2D(f_shape, name='avg_pool')(x)
